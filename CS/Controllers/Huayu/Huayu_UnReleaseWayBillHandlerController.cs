...
namespace CS.Controllers.Huayu
{
    ...
    public class Huayu_UnReleaseWayBillHandlerController : Controller
    {
        ...
        public const string strFileds = "wbStorageDate,wbCompany,wbSerialNum,wbSubNumber,wbTotalWeight,swbTotalNumber,swbTotalWeight,swbTotalActualWeight,wbStatus,releseNum,notReleseNum,wbID";
