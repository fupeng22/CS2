...
namespace CS.Controllers.Huayu
{
    ...
    public class Huayu_QueryController : Controller
    {
        ...
        public const string strFileds = "wbStorageDate,wbCompany,wbSerialNum,wbSubNumber,wbTotalWeight,swbTotalActualNumber,swbTotalNumber,swbTotalWeight,swbTotalActualWeight,wbStatus,releseNum,notReleseNum,wbID";
