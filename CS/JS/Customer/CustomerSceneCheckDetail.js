$(function () {
    ...
    var QueryCheckResultURL = "/Customer_SceneCheckDetail/LoadComboJSONByType?type=CHECK_RESULT";
    var QueryHandleSuggestionURL = "/Customer_SceneCheckDetail/LoadComboJSONByType?type=HANDLE_SUGGESTION";

    var UpdateCheckResultDlg = null;
    var UpdateCheckResultURL = "/Customer_SceneCheckDetail/UpdateCheckResult?swbdID_Local=";

    var UpdateSwbNeedCheckDlg = null;
    var UpdateSwbNeedCheckURL = "/Customer_SceneCheckDetail/UpdateSwbNeedCheck?swbID=";
    ...
    var QueryURL = "/Customer_SceneCheckDetail/GetData?Detail_wbID=" + encodeURI($("#hid_wbID").val()) + "&Detail_swbSerialNum=" + encodeURI($("#txtSubWayBillCode").val());
    ...
    $("#btnQuery_Detail").click(function () {
        QueryURL = "/Customer_SceneCheckDetail/GetData?Detail_wbID=" + encodeURI($("#hid_wbID").val()) + "&Detail_swbSerialNum=" + encodeURI($("#txtSubWayBillCode").val());
