$(function () {
    ...
    var UploadFileURL = "/Huayu_WayBillPatchOutExcel/UploadFile";
    var SaveDataURL = "/Huayu_WayBillPatchOutExcel/SaveData";
    var QueryURL = "/Huayu_WayBillPatchOutExcel/GetSubWayBill";
    ...
    _$_datagrid.datagrid({
        ...
        columns: [[
                    ...
                    { field: 'StatusDecription', title: '说明', width: 230, sortable: true,
                        sorter: function (a, b) {
                            return (a > b ? 1 : -1);
                        }
                    },
                    { field: 'ExceptionStatusDescription', title: '说明', hidden: true, width: 120, sortable: true,
                        sorter: function (a, b) {
                            return (a > b ? 1 : -1);
                        }
                    },
                    { field: 'ExceptionStatus', title: 'ExceptionStatus', hidden: true, width: 120, sortable: true,
                        sorter: function (a, b) {
                            return (a > b ? 1 : -1);
                        }
                    },
