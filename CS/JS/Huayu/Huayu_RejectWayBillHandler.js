$(function () {
    ...
    var DetailURL = "/ViewSubWayBill/Index?Detail_bEnableReject=1&Detail_wbSerialNum=";
    ...
    _$_datagrid.datagrid({
        ...
        columns: [[
                    ...
                    { field: 'wbSubNumber', title: '总件数', width: 80, sortable: true,
                        sorter: function (a, b) {
                            return (a > b ? 1 : -1);
                        }
                    },
    ...
    //                }],
    //                title: '查看退货子运单明细',
    //                href: DetailURL + wbSerialNum + "&Detail_swbStatus=" + defaultStatus,//Detail_RejectSubWayURL + wbSerialNum,
    //                modal: true,
    //                resizable: true,
    //                cache: false,
    //                left: 0,
